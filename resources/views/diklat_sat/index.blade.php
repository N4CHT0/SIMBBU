...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <br>
            <br>
            <table id="DiklatSAT" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Seafare Code</th>
...
<div class="modal fade" id="ModalSAT" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Data Diklat SAT</h5>
...
<div class="modal fade" id="Detail" tabindex="-1" role="dialog" aria-labelledby="DetailLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DetailLabel">Data SAT</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
        ...
        if (confirm('Yakin Ingin Menghapus Data Ini?')) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#DiklatSAT').DataTable().ajax.reload();
                },
    ...
    function simpan(id = '') {
        ...
        // Kirim permintaan
        $.ajax({
            url: id === '' ? 'DiklatSATAjax' : 'DiklatSATAjax/' + id,
            type: methodType,
            data: data,
            contentType: false,
            processData: false,
    ...
    $('#ModalSAT').on('hidden.bs.modal', function () {
        var inputFoto = $('#foto');
