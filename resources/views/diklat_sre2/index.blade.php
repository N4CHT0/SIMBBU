...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <br>
            <br>
            <table id="DiklatSRE2" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>NIK</th>
...
<div class="modal fade" id="ModalSRE2" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Data Diklat SRE2</h5>
...
<div class="modal fade" id="Detail" tabindex="-1" role="dialog" aria-labelledby="DetailLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DetailLabel">Data Diklat SRE2</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        $(function () {
            $('#DiklatSRE2').DataTable({
                "ajax": "{{ url('DiklatSRE2Ajax') }}",
                "columns": [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            if (confirm('Yakin Ingin Menghapus Data Ini?')) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#DiklatSRE2').DataTable().ajax.reload();
                    },
        ...
        function simpan(id = '') {
            ...
            // Kirim permintaan
            $.ajax({
                url: id === '' ? 'DiklatSRE2Ajax' : 'DiklatSRE2Ajax/' + id,
                type: methodType,
                data: data,
                contentType: false,
                processData: false,
        ...
        $('#ModalSRE2').on('hidden.bs.modal', function () {
            var inputFoto = $('#foto');
