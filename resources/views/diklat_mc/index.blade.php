...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <br>
            <br>
            <table id="DiklatMC" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Seafare Code</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Data Diklat MC</h5>
...
<div class="modal fade" id="Detail" tabindex="-1" role="dialog" aria-labelledby="DetailLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DetailLabel">Data MC</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
        ...
        if (confirm('Yakin Ingin Menghapus Data Ini?')) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#DiklatMC').DataTable().ajax.reload();
                },
    ...
    function simpan(id = '') {
        ...
        // Kirim permintaan
        $.ajax({
            url: id === '' ? 'DiklatMCAjax' : 'DiklatMCAjax/' + id,
            type: methodType,
            data: data,
            contentType: false,
            processData: false,
    ...
    $('#ModalMC').on('hidden.bs.modal', function () {
        var inputFoto = $('#foto');
