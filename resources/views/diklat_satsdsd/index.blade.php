...
<div class="modal fade" id="ModalSATSDSD" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Data Diklat SATSDSD</h5>
...
<div class="modal fade" id="Detail" tabindex="-1" role="dialog" aria-labelledby="DetailLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DetailLabel">Data SATSDSD</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    // ...
    $(function () {
        $('#DiklatSATSDSD').DataTable({
            "ajax": "{{ url('DiklatSATSDSDAjax') }}",
            "columns": [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
        ...
        if (confirm('Yakin Ingin Menghapus Data Ini?')) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#DiklatSATSDSD').DataTable().ajax.reload();
                },
    ...
    function simpan(id = '') {
        ...
        // Kirim permintaan
        $.ajax({
            url: id === '' ? 'DiklatSATSDSDAjax' : 'DiklatSATSDSDAjax/' + id,
            type: methodType,
            data: data,
            contentType: false,
            processData: false,
    ...
    $('#ModalSATSDSD').on('hidden.bs.modal', function () {
        var inputFoto = $('#foto');
