...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <br>
            <br>
            <table id="DiklatSOUR" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>NIK</th>
...
<div class="modal fade" id="ModalSOUR" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Data Diklat SOUR</h5>
...
<div class="modal fade" id="Detail" tabindex="-1" role="dialog" aria-labelledby="DetailLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DetailLabel">Data Diklat SOUR</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        $(function () {
            $('#DiklatSOUR').DataTable({
                "ajax": "{{ url('DiklatSOURAjax') }}",
                "columns": [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            if (confirm('Yakin Ingin Menghapus Data Ini?')) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#DiklatSOUR').DataTable().ajax.reload();
                    },
        ...
        function simpan(id = '') {
            ...
            // Kirim permintaan
            $.ajax({
                url: id === '' ? 'DiklatSOURAjax' : 'DiklatSOURAjax/' + id,
                type: methodType,
                data: data,
                contentType: false,
                processData: false,
        ...
        $('#ModalSOUR').on('hidden.bs.modal', function () {
            var inputFoto = $('#foto');
