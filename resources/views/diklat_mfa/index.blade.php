...
<div class="modal fade" id="ModalMFA" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Data Diklat MFA</h5>
...
<div class="modal fade" id="Detail" tabindex="-1" role="dialog" aria-labelledby="DetailLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DetailLabel">Data MFA</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    function simpan(id = '') {
        ...
        // Kirim permintaan
        $.ajax({
            url: id === '' ? 'DiklatMFAAjax' : 'DiklatMFAAjax/' + id,
            type: methodType,
            data: data,
            contentType: false,
            processData: false,
    ...
    $('#ModalMFA').on('hidden.bs.modal', function () {
        var inputFoto = $('#foto');
