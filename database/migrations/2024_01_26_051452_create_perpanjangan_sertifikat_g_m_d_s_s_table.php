...
return new class extends Migration
{
    ...
    {
        Schema::create('perpanjangan_sertifikat_g_m_d_s_s', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->string('seafare_code');
            $table->string('nik');
            $table->string('diklat_asal');
            ...
            $table->string('scan_foto_akte_kelahiran');
            $table->string('email');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('perpanjangan_sertifikat_g_m_d_s_s');
    }
};
