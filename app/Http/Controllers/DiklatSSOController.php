...
use App\Models\DiklatSSO;
use Illuminate\Http\Request;
use Yajra\DataTables\Facades\DataTables;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Storage;
class DiklatSSOController extends Controller
{
    /**
    ...
    {
        $data = DiklatSSO::orderBy('nama_lengkap', 'asc');
        return DataTables::of($data)
        ->addIndexColumn()
        ->addColumn('action', function($data){
            return view('diklat_sso.button',compact('data'));
        })
        ->make(true);
    }
    ...
    {
        $data = DiklatSSO::where('id', $id)->first();
