...
use App\Models\DiklatSAT;
use Illuminate\Http\Request;
use Yajra\DataTables\Facades\DataTables;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Storage;
class DiklatSATController extends Controller
{
    /**
    ...
    {
        $data = DiklatSAT::orderBy('nama_lengkap', 'asc');
        return DataTables::of($data)
        ->addIndexColumn()
        ->addColumn('action', function($data){
            return view('diklat_sat.button',compact('data'));
        })
        ->make(true);
    }
    ...
    {
        $data = DiklatSAT::where('id', $id)->first();
